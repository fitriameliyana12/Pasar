...
<body>
							...
							<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
                                <div class="container">
                                    <a class="navbar-brand" href="#">
                                        <img src="images/logo/logo.png" alt="" width="60%" height="60%">
                                    </a>
						        </div>
						    </nav>
					    </div>
	...
	<div class="text-center">
         <img src="gambar produk\jombang.gif" class="rounded" alt="image1">
    </div>
								...
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="<?php echo base_url(); ?>home/produk/<?php echo $value['id_produk']; ?>">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												...
												<a href="<?php echo base_url(); ?>home/detail/<?php echo $value['id_produk']; ?>" class="btn btn-default add-to-cart"><i class="fa fa-info"></i>Detail</a>
											</div>
										</div>
									</div>
								</div>
