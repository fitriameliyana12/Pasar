				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							...
							?>
							<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>images/logo/<?php echo $logo;?>" alt="Lijo Jombang" /></a>
						</div>
					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Kategori:</b> <?php echo $nama_kategori;?></p>
								<p><b>Pasar:</b> <?php echo $nama_brand;?></p>
