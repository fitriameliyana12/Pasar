					...
					<div class="span10">
						...
						<div class="inbox-content">
							...
							<div class="inbox-compose form-horizontal" >
									...
									<div class="inbox-control-group">
										<textarea class="span12  wysihtml5 m-wrap" name="isi_hubungi_kami_kirim" id="isi_hubungi_kami_kirim" rows="12"></textarea>
									</div>
				...
				$("#isi_hubungi_kami_kirim").focus();
                            ...
                            if (!email_check[1] || !email_check2[0] || !email_check2[1]) {
                                ...
                                return false;
                            	 ...
                            	 $.ajax({
                                    type:"POST",
                                    url :"<?php echo base_url();?>adminweb/buku_tamu_balas_simpan",
