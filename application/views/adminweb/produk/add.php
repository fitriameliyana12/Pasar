						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
												<label class="control-label">Pasar</label>
												<div class="controls">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nama" id="nama" class="span6 m-wrap" placeholder="Nama Penjual..." />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="no_tlp" id="no_tlp" class="span6 m-wrap" placeholder="Nomor telepon yang bisa dihubungi..." />
										</div>
									</div>
